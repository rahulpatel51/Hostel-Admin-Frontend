...
import { Eye, EyeOff, Lock, Home, Info, Contact, LogIn, Mail, ShieldCheck, UserCog, KeyRound, Copy, Check } from "lucide-react"
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-teal-100/30 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-center items-center p-8 bg-gradient-to-br from-teal-600/10 via-emerald-600/5 to-teal-700/10 dark:from-teal-900/20 dark:via-emerald-900/10 dark:to-teal-800/20 border-r border-teal-200/50 dark:border-gray-700">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center mb-8">
            <div className="w-24 h-24 bg-teal-100/50 dark:bg-teal-900/20 rounded-full flex items-center justify-center mx-auto mb-6 border-4 border-teal-300/30 dark:border-teal-700/30">
              <UserCog className="h-10 w-10 text-teal-600 dark:text-teal-400" />
            </div>
            <h2 className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-emerald-600 dark:from-teal-400 dark:to-emerald-400 bg-clip-text text-transparent">
              Admin Demo Access
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Use the following credentials to test the admin portal
            </p>
          </div>

          {/* Demo Credentials Card */}
          <Card className="border-teal-200 dark:border-gray-700 shadow-lg bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Copy these credentials or fill them automatically
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <div className="flex-1 p-3 bg-teal-50/50 dark:bg-teal-900/20 rounded-lg border border-teal-200 dark:border-teal-800">
                    <code className="text-sm text-teal-700 dark:text-teal-300 font-mono">
            ...
            <CardFooter>
              <Button
                ...
                className="w-full bg-teal-100 hover:bg-teal-200 text-teal-700 dark:bg-teal-900/30 dark:hover:bg-teal-900/50 dark:text-teal-300"
                variant="outline"
              >
          ...
          <div className="space-y-4 mt-8">
            <h3 className="font-semibold text-gray-700 dark:text-gray-300 text-lg">Admin Portal Features</h3>
