import { BookOpenCheck, CalendarDays, Clock, Contact, FileText, HelpCircle, Home, Info, Library, LogIn, Mail, MapPin, Phone, School, Shield } from "lucide-react"
...
export default function AdmissionsPage() {
    const admissionSteps = [
        ...
        {
            icon: <Library className="h-6 w-6 text-teal-600" />,
            title: "2. Document Submission",
            description: "Upload necessary academic documents and identification"
        },
        {
            icon: <CalendarDays className="h-6 w-6 text-teal-600" />,
            title: "3. Interview",
            description: "Attend a virtual or in-person interview (if required)"
        },
        {
            icon: <BookOpenCheck className="h-6 w-6 text-teal-600" />,
            title: "4. Admission Decision",
            description: "Receive your admission status within 7-10 working days"
        },
        {
            icon: <Shield className="h-6 w-6 text-teal-600" />,
            title: "5. Fee Payment",
            description: "Pay the admission and hostel fees to secure your seat"
        },
        {
            icon: <School className="h-6 w-6 text-teal-600" />,
            title: "6. Orientation",
            description: "Attend the orientation program before classes begin"
        }
    ];
            ...
            <main className="flex-1 container mx-auto py-12 px-4 sm:px-6">
                ...
                <section className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                        Begin your journey at Goel Group with our streamlined hostel admission process for the 2023-24 academic year.
                    </p>
                </section>
                ...
                <section className="max-w-6xl mx-auto mb-20">
                    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-8">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">
                            <span className="text-teal-600 dark:text-teal-400">Admission</span> Process
                        </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto mb-20">
                    ...
                    <Card className="border-teal-200 dark:border-gray-700">
                        <CardHeader className="p-6 border-b border-teal-100/50 dark:border-gray-700">
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                                <span className="text-teal-600 dark:text-teal-400">Required</span> Documents
                            </h2>
                            <p className="text-gray-600 dark:text-gray-400">Prepare these documents before starting your application</p>
                        </CardHeader>
                        <div className="p-6">
                            <ul className="space-y-3">
                                {requiredDocuments.map((doc, index) => (
                                    <li key={index} className="flex items-start gap-3">
                                        <div className="bg-teal-100 dark:bg-teal-900/30 p-1 rounded-full mt-1">
                    ...
                    <Card className="border-teal-200 dark:border-gray-700">
                        <CardHeader className="p-6 border-b border-teal-100/50 dark:border-gray-700">
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                                <span className="text-teal-600 dark:text-teal-400">Important</span> Dates
                            </h2>
                            <p className="text-gray-600 dark:text-gray-400">Key deadlines for the 2023-24 academic year</p>
                        </CardHeader>
                        <div className="p-6">
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400">1st April - 30th June 2023</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-teal-100/50 dark:bg-teal-900/20 p-3 rounded-lg flex-shrink-0">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">Interview Dates</h3>
                                        <p className="text-gray-600 dark:text-gray-400">15th - 20th July 2023</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-teal-100/50 dark:bg-teal-900/20 p-3 rounded-lg flex-shrink-0">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">Fee Payment Deadline</h3>
                                        <p className="text-gray-600 dark:text-gray-400">31st July 2023</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-teal-100/50 dark:bg-teal-900/20 p-3 rounded-lg flex-shrink-0">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">Orientation Week</h3>
                                        <p className="text-gray-600 dark:text-gray-400">15th - 19th August 2023</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="max-w-6xl mx-auto mb-20 bg-gradient-to-r from-teal-50 to-emerald-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">
                        <span className="text-teal-600 dark:text-teal-400">Hostel Fee</span> Structure
                    </h2>
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-teal-200 dark:border-gray-600">
                                    <th className="text-left py-4 px-6 text-gray-700 dark:text-gray-300 font-medium">Hostel</th>
                                    <th className="text-left py-4 px-6 text-gray-700 dark:text-gray-300 font-medium">Room Type</th>
                                    <th className="text-right py-4 px-6 text-gray-700 dark:text-gray-300 font-medium">Annual Fee</th>
                                    <th className="text-right py-4 px-6 text-gray-700 dark:text-gray-300 font-medium">Security Deposit</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className="border-b border-teal-100/50 dark:border-gray-700">
                                    <td className="py-4 px-6 text-gray-900 dark:text-white">Saraswati (Girls)</td>
                                    <td className="py-4 px-6 text-gray-600 dark:text-gray-400">Single Occupancy</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹85,000</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹15,000</td>
                                </tr>
                                <tr className="border-b border-teal-100/50 dark:border-gray-700">
                                    <td className="py-4 px-6 text-gray-900 dark:text-white">Saraswati (Girls)</td>
                                    <td className="py-4 px-6 text-gray-600 dark:text-gray-400">Double Occupancy</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹65,000</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹15,000</td>
                                </tr>
                                <tr className="border-b border-teal-100/50 dark:border-gray-700">
                                    <td className="py-4 px-6 text-gray-900 dark:text-white">Laxmi (Girls)</td>
                                    <td className="py-4 px-6 text-gray-600 dark:text-gray-400">Triple Occupancy</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹55,000</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹15,000</td>
                                </tr>
                                <tr>
                                    <td className="py-4 px-6 text-gray-900 dark:text-white">Shiva (Boys)</td>
                                    <td className="py-4 px-6 text-gray-600 dark:text-gray-400">Double Occupancy</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹60,000</td>
                                    <td className="py-4 px-6 text-right text-gray-900 dark:text-white">₹15,000</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-600 dark:text-gray-400 mb-4">*Mess charges included. Fees are subject to revision.</p>
                        <Button variant="outline" className="border-teal-600 text-teal-600 dark:border-teal-400 dark:text-teal-400">
                ...
                <section className="max-w-4xl mx-auto mb-20">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">
                        <span className="text-teal-600 dark:text-teal-400">Frequently Asked</span> Questions
                    </h2>
                    <div className="space-y-4">
                        {[
                            {
                                question: "What are the eligibility criteria for hostel admission?",
                                answer: "Students must be enrolled in any Goel Group institution and maintain good academic standing. Priority is given to out-of-town students."
                            },
                            {
                                question: "Can I visit the hostel before applying?",
                                answer: "Yes, we conduct campus tours every Friday. Please schedule your visit through our contact page."
                            },
                            {
                                question: "Is the hostel fee refundable?",
                                answer: "The security deposit is refundable upon completion of your stay, minus any damages. The annual fee is non-refundable."
                            },
                            {
                                question: "What amenities are included in the hostel fee?",
                                answer: "The fee includes accommodation, meals, WiFi, laundry, and access to all common facilities like the library and gym."
                            }
                        ].map((faq, index) => (
                            <Card key={index} className="border-teal-100 dark:border-gray-700">
                                <details className="group">
                                    <summary className="flex items-center justify-between p-6 cursor-pointer">
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white">{faq.question}</h3>
                                        <div className="ml-4 flex-shrink-0">
                                            <HelpCircle className="h-5 w-5 text-teal-600 dark:text-teal-400 group-open:hidden" />
                                            <HelpCircle className="h-5 w-5 text-teal-600 dark:text-teal-400 hidden group-open:block" />
                                        </div>
                                    </summary>
                ...
                <section className="max-w-4xl mx-auto text-center">
                    <div className="bg-teal-600 rounded-2xl p-8 text-white">
                        ...
                        <p className="mb-6 opacity-90">Our admission team is ready to assist you with any questions about hostel admissions.</p>
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            ...
                            <div className="flex items-center justify-center gap-2 text-white/90">
                                ...
                                <span>admissions@goelgroup.edu</span>
                            </div>
                        </div>
                    </div>
                </section>
